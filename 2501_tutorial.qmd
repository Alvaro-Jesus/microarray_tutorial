...
# 6.1 Basic plotting
boxplot(exprs(gse2), col = "lightblue", main = "Expression Distribution", las = 2)
...
pacman::p_load(marray)
limma::plotMA(gse2, main = "MA Plot")
sum(is.na(exprs(gse2)))

# 6.2 customized plotting A
library(reshape2)
exprs_data <- as.data.frame(log2(exprs(gse2)))
exprs_data_melt <- melt(exprs_data)
ggplot(exprs_data_melt, aes(x = variable, y = value)) +
  geom_boxplot(fill = "lightblue") +
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  labs(title = "Expression Distribution", x = "Samples", y = "Expression Value")
...
gsm2_ma <- normalizeWithinArrays(gsm2, method="loess")
