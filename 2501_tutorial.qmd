...
pacman::p_load(GEOquery, tidyverse, ggrepel, survminer, limma)

# tips: browseVignettes('packagename')
# tips: methods(class=class(foo))
# for vscode: install.packages("httpgd")
# for vscode: pip3 install -U radian
```

### 2. Scenario A: Assuming everything is fine
```{r}
htlv_id = "GSE55851"
htlv_tempdir=".temp/"
...
pheatmap(cor(exprs(gse2), use="c"), annotation_col=pinfo) #c stops if any missing data point
...
agilent_data_bg <- backgroundCorrect(exprs(gse2), method = "rma")
